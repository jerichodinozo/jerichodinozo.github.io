    ...
    <div id='page2' class="page">
        ...
        <div id='page3'class='page'>
            <motion.div 
                ...
                viewport={{once:true}}
                transition={{duration: 1.5}}> 
                <h2 id='page-title'>PAGE 2: <br></br>RECENT<br></br>WORKS</h2></motion.div>
                <div class="skillsandabout projects-sect">
                    <motion.div class="project-container">
                        <div class="img"></div>
