...
<Navbar />
    ...
    <div id="page1">
        ...
        <div id="background-container projects-sect" class="page skillsandabout ">
        ...
        <div id='page1'>
           ...
           <div class="skillsandabout" id="background-container projects-sect">
                <StaggerAnimation className='project-title' word="PROJECT 1" />
                <div>sjshflksdhfl</div>
           </div>
        </div>
    </AnimatePresence>
        </>
