...
import { motion, AnimateSharedLayout, AnimatePresence, easeIn } from "framer-motion";
...
<>
        <div id="homepage" class="page">
            ...
            <div id="home-elements" className="banner">
                ...
                {/*<div id="name-title">
                    <motion.div variants={container} initial="hidden" animate="show" id="name-element">
                        <motion.span variants={item}>JERICHO</motion.span><br/>
                        <motion.span variants={item}> DINOZO</motion.span>
                    </motion.div>
                </div>*/}

                <motion.div className="name-title"></motion.div>
